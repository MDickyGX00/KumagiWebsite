...
const ContactUs = () => {
  ...
  return (
    <div className="kontak bg-yellow-400 px-5 py-20" id="kontak">
        <h2 className="xl:text-5xl text-2xl font-bold mb-2 text-center">Hubungi Kami</h2>
        <p className="text-center mb-10">Jika anda memiliki keluhan, silahkan hubungi kami disini!</p>
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="hidden sm:grid grid-cols-2 gap-4 px-10 ">
            ...
            <div className="p-4 border rounded shadow bg-white text-center py-10">
              ...
              <p>Universitas Sumatera Utara, Jl. Universitas No.9, Padang Bulan, Kec. Medan Baru, Kota Medan, Sumatera Utara 20155</p>
            </div>
            <div className="p-4 border rounded shadow bg-white text-center py-10">
